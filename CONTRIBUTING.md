...
Want to help make `lift-fail` faster, want to help expand it
...
Documentation is an important part of any project and `lift-fail` is no
...
If you're here then you've probably encountered an issue with `lift-fail`,
...
- What happened?
- What steps did you take with `lift-fail` to try to make that happen?
